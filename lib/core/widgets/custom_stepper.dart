...
/// A builder that creates the icon widget for the [StepItem] at [stepIndex], given
/// [stepState].
...
/// This class is used to override the default visual properties of [StepItem] widgets within a [CustomStepper].
///
/// To customize the appearance of a [StepItem] create an instance of this class with non-null parameters
...
///
/// {@tool dartpad}
/// An example that uses [StepStyle] to customize the appearance of each [StepItem] in a [CustomStepper].
///
