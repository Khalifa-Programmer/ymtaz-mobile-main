...
part 'available_lawyers_for_advisory_type_model.g.dart';

@JsonSerializable()
class AvailableLawyersForAdvisoryTypeModel {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory AvailableLawyersForAdvisoryTypeModel.fromJson(
          Map<String, dynamic> json) =>
      _$AvailableLawyersForAdvisoryTypeModelFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AvailableLawyersForAdvisoryTypeModelToJson(this);
}
