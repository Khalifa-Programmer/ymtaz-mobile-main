...
//       PaymentAdvisoryScreenState(link);
// }
//
...
//
//   PaymentAdvisoryScreenState(this.url);
//
//   String url = "";
//   bool success = false;
//   int progress = 0;
...
//                       'https://api.ymtaz.sa/api/payments/callback/account/advisory-services/') && success == true) {
//                 Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                         builder: (context) =>
//                             SuccessPaymentInvoice()));
//                 // AppAlerts.showAlert(
//                 //   context: context,
