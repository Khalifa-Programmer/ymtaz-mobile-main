...
class SuccessPayment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: appColors.white, // Background color similar to the screenshot
      body: SafeArea(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpace(5.h),
                Text(
                  getTimeDate(DateTime.now().toString()), // Current date, as in the screenshot
  ...
  Widget _buildInfoSection() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildInfoColumn('الرقم الضريبي', '3021550606'), // Static Tax ID as an example
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Divider(color: appColors.grey5 , thickness: 0.3),
          verticalSpace(10.h),
          _buildDetailsRow('وقت الشراء', getTimeDate(DateTime.now().toString()), appColors.black),
          verticalSpace(10.h),
