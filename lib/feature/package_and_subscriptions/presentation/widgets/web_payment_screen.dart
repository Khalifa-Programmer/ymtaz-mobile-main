...
// import 'package:yamtaz/feature/package_and_subscriptions/presentation/widgets/success_payment.dart';
//
// import '../../data/model/packages_subscribe_model.dart';
//
// class PaymentScreen extends StatefulWidget {
//   const PaymentScreen({super.key, required this.link, required this.data});
//
//   final String link;
//   final PackagesSubscribeModel data;
//
//   @override
//   State<PaymentScreen> createState() => PaymentScreenState(link, data);
// }
//
...
//
//   PaymentScreenState(this.url, this.data);
//
//   final PackagesSubscribeModel data;
//
//   String url = "";
...
//                       'https://api.ymtaz.sa/api/payments/callback/account/packages/') && success == true) {
//                 Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                         builder: (context) => SuccessPayment(data: data)));
//
//               } else if (url != null &&
//                   url.toString().contains(
//                       'https://api.ymtaz.sa/api/payments/callback/account/packages/')&& success == true) {
