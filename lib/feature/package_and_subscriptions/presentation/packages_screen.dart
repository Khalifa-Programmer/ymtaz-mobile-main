            ...
            builder: (BuildContext context) {
              return SingleChildScrollView(
                child: ConditionalBuilder(
                  condition: getit<PackagesAndSubscriptionsCubit>().isSubscribed == false ,
                  builder: (BuildContext context) {
                    return Column(
                      children: [
                        SizedBox(
                            ...
                            child: PackageSlider(packages: getit<PackagesAndSubscriptionsCubit>().packagesModel!.data!.packages!,)),
