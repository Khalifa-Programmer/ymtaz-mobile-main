...
part 'appointment_office_reservations_client.g.dart';

@JsonSerializable()
class AppointmentOfficeReservationsClient {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory AppointmentOfficeReservationsClient.fromJson(
          Map<String, dynamic> json) =>
      _$AppointmentOfficeReservationsClientFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AppointmentOfficeReservationsClientToJson(this);
}
...
class LawyerSection {
  ...
  factory LawyerSection.fromJson(Map<String, dynamic> json) =>
      _$LawyerSectionFromJson(json);
