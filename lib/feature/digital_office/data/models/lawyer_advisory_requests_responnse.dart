...
part 'lawyer_advisory_requests_responnse.g.dart';

@JsonSerializable()
class LawyerAdvisoriesRequestsResponnse {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  LawyerAdvisoriesRequestsResponnse({
    this.status,
    this.code,
    this.message,
    this.data,
  ...
  factory LawyerAdvisoriesRequestsResponnse.fromJson(
          Map<String, dynamic> json) =>
      _$LawyerAdvisoriesRequestsResponnseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$LawyerAdvisoriesRequestsResponnseToJson(this);
}
