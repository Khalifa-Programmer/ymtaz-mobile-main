...
class ServiceScreenSetailsClient extends StatefulWidget {
  ServiceScreenSetailsClient(
  ...
  @override
  State<ServiceScreenSetailsClient> createState() =>
      _ServiceScreenSetailsClientState();
}

class _ServiceScreenSetailsClientState
    extends State<ServiceScreenSetailsClient> {
  ...
  void viewImage(BuildContext context, param1) {}
}
