...
import '../widgets/appointments_orders/my_services_clients_screen.dart';
import '../widgets/appointments_orders/pending_requests_screen.dart';

class MyAppointmentsLawyerScreen extends StatelessWidget {
  const MyAppointmentsLawyerScreen({super.key});
        ...
        return DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: TabBarView(children: [
                ConditionalBuilder(
                  condition:
                      getit<OfficeProviderCubit>().pendingAppointmentsRequest !=
                          null,
                  builder: (BuildContext context) {
                    return AppointmetnsPendingRequestsScreen(
