...
class AppointmentsAdjustScreen extends StatelessWidget {
  ...
  ReservationType? serviceDataNew;
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getit<OfficeProviderCubit>()
        ..getAppointmentsListPrices(serviceData),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text("جاري تخصيص الموعد لملفك"),
                        ],
                      ),
                    ),
                  );
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return Animate(
                                ...
                                child: serviceData.isActivated == true
                                    ? PriceData(
                                        serviceData.lawyerPrices!, index)
                                    : PriceDataYmtaz(
                                        serviceData.ymtazPrices!, index));
                          },
                            ...
                            onPress: () {
                              ...
                              if (serviceDataNew!.isActivated == true) {
                                for (int i = 0;
                                    ...
                                    i++) {
                                  data["reservationsTypesImportances[$i][${"importance_id"}]"] =
                                      serviceDataNew!
                                          .lawyerPrices![i].level!.id;

                                  data["reservationsTypesImportances[$i][${"isHidden"}]"] =
                                      serviceDataNew!.lawyerPrices![i].isHidden;

                                  data["reservationsTypesImportances[$i][${'price'}]"] =
                                      context
                                          .read<OfficeProviderCubit>()
...
//
                                  data["reservationsTypesImportances[$i][${"isHidden"}]"] =
                                      serviceData.ymtazPrices![i].isHidden;
      ...
      children: [
        ...
        CupertinoButton(
          ...
          onPressed: () {
            context.read<OfficeProviderCubit>().hideAppointments(
                ...
                serviceDataNew!.isHidden == 1 ? true : false);
          },
          child: Row(
            children: [
              CircleAvatar(
        ...
        CupertinoButton(
          onPressed: () {
            context
                .read<OfficeProviderCubit>()
                .deleteAppointments(serviceData.id!.toString());
          },
          padding: EdgeInsets.zero,
          child: Row(
            children: [
...
class PriceDataYmtaz extends StatefulWidget {
  PriceDataYmtaz(this.data, this.index, {super.key});

  List<Price> data;
  int index;

  @override
  State<PriceDataYmtaz> createState() => _PriceDataYmtazState();
}

class _PriceDataYmtazState extends State<PriceDataYmtaz> {
  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          ...
          child: SizedBox(
            ...
            child: CupertinoTextField(
              ...
              placeholderStyle: TextStyles.cairo_14_bold.copyWith(
                color: appColors.grey15,
              ),
              style: TextStyles.cairo_14_bold.copyWith(
                color: appColors.black,
