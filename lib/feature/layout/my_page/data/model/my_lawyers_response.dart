...
part 'my_lawyers_response.g.dart';

@JsonSerializable()
class MyLawyersResponse {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory MyLawyersResponse.fromJson(Map<String, dynamic> json) =>
      _$MyLawyersResponseFromJson(json);

  Map<String, dynamic> toJson() => _$MyLawyersResponseToJson(this);
}
