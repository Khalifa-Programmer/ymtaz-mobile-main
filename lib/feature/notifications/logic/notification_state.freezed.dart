...
mixin _$NotificationState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NotificationsResponseModel data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NotificationsResponseModel data)? loaded,
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NotificationsResponseModel data});
}
...
class _$LoadedImpl<T> implements Loaded<T> {
  ...
  @override
  final NotificationsResponseModel data;

  @override
  String toString() {
    return 'NotificationState<$T>.loaded(data: $data)';
  }
...
abstract class Loaded<T> implements NotificationState<T> {
  const factory Loaded(final NotificationsResponseModel data) = _$LoadedImpl<T>;

  NotificationsResponseModel get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<T, _$LoadedImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.success(message: $message)';
  }
...
abstract class Success<T> implements NotificationState<T> {
  const factory Success(final String message) = _$SuccessImpl<T>;
