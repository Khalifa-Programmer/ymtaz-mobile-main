...
part 'sign_up_provider_response_body.g.dart';

@JsonSerializable()
class SignUpProviderResponse {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory SignUpProviderResponse.fromJson(Map<String, dynamic> json) =>
      _$SignUpProviderResponseFromJson(json);

  Map<String, dynamic> toJson() => _$SignUpProviderResponseToJson(this);
}
