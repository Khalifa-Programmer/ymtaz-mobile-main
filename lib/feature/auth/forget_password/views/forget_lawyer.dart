...
class ForgetPasswordLawyerScreen extends StatelessWidget {
  const ForgetPasswordLawyerScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocListener<ForgetCubit, ForgetState>(
      ...
      listener: (context, state) {
        state.whenOrNull(
          ...
          successEmailCheck: (successLoginMessage) {
            context.pop();
            context.pushNamedAndRemoveUntil(Routes.forgetPasswordOtpProvider,
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(LocaleKeys.forgetPass.tr(),
