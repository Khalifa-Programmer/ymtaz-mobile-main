...
part 'digital_search_response_model.g.dart';

@JsonSerializable()
class DigitalSearchResponseModel {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory DigitalSearchResponseModel.fromJson(Map<String, dynamic> json) =>
      _$DigitalSearchResponseModelFromJson(json);

  Map<String, dynamic> toJson() => _$DigitalSearchResponseModelToJson(this);
}
