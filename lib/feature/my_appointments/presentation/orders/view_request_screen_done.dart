...
class ViewAppointmentDoneScreen extends StatelessWidget {
  ...
  Widget _buildBreadcrumbSection(Accepted offer) {
    final parts = <String>[];
    if (offer.reservationImportance?.title != null && offer.reservationImportance!.title!.isNotEmpty) {
      parts.add(offer.reservationImportance!.title!);
    }
