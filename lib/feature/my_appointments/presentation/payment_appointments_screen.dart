...
// import '../data/model/appointment_request_response.dart';
//
// class PaymentAppointmetns extends StatefulWidget {
//   const PaymentAppointmetns(
...
//
//   @override
//   State<PaymentAppointmetns> createState() =>
//       PaymentAppointmetnsState(link, data);
// }
//
// class PaymentAppointmetnsState extends State<PaymentAppointmetns> {
//   HeadlessInAppWebView? headlessWebView;
//   PullToRefreshController? pullToRefreshController;
//   InAppWebViewController? webViewController;
//
//   PaymentAppointmetnsState(this.url, this.data);
//
//   final AppontmentRequestResponse data;
//   String url = "";
//   bool success = false;
...
//                       'https://api.ymtaz.sa/api/payments/callback/account/reservations/') && success == true) {
//
//
//                 context.pushNamedAndRemoveUntil(Routes.homeLayout, predicate: (Route<dynamic> route)=> false);
