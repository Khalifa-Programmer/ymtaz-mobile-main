...
part 'advisory_services_response.g.dart';

@JsonSerializable()
class AdvisoryServicesResponse {
  @JsonKey(name: "status")
  bool? status;
  @JsonKey(name: "code")
  int? code;
  ...
  factory AdvisoryServicesResponse.fromJson(Map<String, dynamic> json) =>
      _$AdvisoryServicesResponseFromJson(json);

  Map<String, dynamic> toJson() => _$AdvisoryServicesResponseToJson(this);
}
