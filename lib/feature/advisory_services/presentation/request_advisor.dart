...
import '../../../yamtaz.dart';
import '../../layout/account/data/models/advisory_services_types_response.dart';
import '../../layout/account/presentation/guest_screen.dart';
import '../logic/advisor_cubit.dart';

class RequestAdvisor extends StatefulWidget {
  RequestAdvisor({super.key, required this.data});

  ItemAdvisor data;

  @override
  State<RequestAdvisor> createState() => _RequestAdvisorState();
}

class _RequestAdvisorState extends State<RequestAdvisor> {
                    ...
                    children: [
                      CustomContainer(
                          ...
                          child: CustomDropdown<Item>(
                            ...
                            items: getit<AdvisorCubit>()
                                ...
                                .items!,
                            onChanged: (value) {
                              selectedTypeIndex = getit<AdvisorCubit>()
                                  .typesResponse!
                                  .data!
                                  .items!
                                  .indexOf(value!);
                      ...
                      ConditionalBuilder(
                        ...
                        builder: (BuildContext context) => CustomContainer(
                            title: 'مستوي الاستشارة',
                            child:
                                CustomDropdown<AdvisoryServicePriceFromTypes>(
                              validator: (value) {
                                if (value == null) {
                                  return 'مستوى الطلب';
                                }
                      ...
                      CustomButton(
                        ...
                        onPress: () {
                          ...
                          if (userType == "guest") {
                            ...
                            if (widget.data.needAppointment == 1) {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => BlocProvider.value(
                                    value: getit<AdvisorCubit>()
                                      ..getAvailableTimes(),
                                    child: AdvisoryRequestTime(
                              ...
                              //     arguments: data);
                                    ...
                                    .data.paymentCategory!.paymentMethod ==
                                "مجانية") {
                              ...
                              context.read<AdvisorCubit>().createAppointment(
                                    formData,
                                  );
                            } else {
                              Map<String, dynamic> data = {
