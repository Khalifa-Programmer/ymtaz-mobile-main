...
class FastSearchRequestAdvisor extends StatefulWidget {
  FastSearchRequestAdvisor({super.key, required this.data});

  AdvisoryServicesType data;

  @override
  State<FastSearchRequestAdvisor> createState() =>
      _FastSearchRequestAdvisorState();
}

class _FastSearchRequestAdvisorState extends State<FastSearchRequestAdvisor> {
