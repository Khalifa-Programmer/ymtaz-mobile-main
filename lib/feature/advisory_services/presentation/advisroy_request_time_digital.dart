...
class AdvisoryRequestTimeDigital extends StatefulWidget {
  AdvisoryRequestTimeDigital(
      {super.key,
        required this.data,
        required this.typeId,
        required this.note,
        required this.importanceId,
        this.lawyerId, required this.serviceId});
  ...
  @override
  State<AdvisoryRequestTimeDigital> createState() => _AdvisoryRequestTimeState();
}

class _AdvisoryRequestTimeState extends State<AdvisoryRequestTimeDigital> {
  @override
              ...
              onPress: () {
                if (widget.selectedTimeId != -1) {
                  FormData data = FormData.fromMap({
                    ...
                    "advisory_services_id": widget.serviceId,
                    "accept_rules": 1,
                    "hours": 1
                  });

                  context.read<AdvisorCubit>().createAppointmentWithLawyer(data);
                }
              })
        ],
      ),
